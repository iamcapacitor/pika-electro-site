...
function App() {
  ...
  return (
    <>
      ...
      <section className='servicesection bg-(--servicebg) text-(--servicetext) p-2 py-10 grid place-items-center'>
        ...
        <div className="servicesbox flex flex-wrap justify-center items-center  md:grid  md:grid-cols-3 gap-4 sm:place-items-center w-full md:w-fit">
          {services.map((s, i) => {
            return (
              <div key={i} className="service1 bg-(--scolor) p-2 py-5 rounded-md grid place-items-center gap-4 text-md font-semibold w-50 md:w-60 min-w-fit max-w-sm hover:scale-[1.02] hover:shadow shadow-amber-200 ">
